Feature: Companies
    ...
    Scenario: Try to authorize a user to be the company's  admin but without passing a user id
        When The MetApprendo admin sends a request to authorize a specific user without passing a "userId"
    ...
    Scenario: Try to authorize a user to be the company's  admin but passing a company id related to a company that dosn't exist
        When The MetApprendo admin sends a request to authorize a specific user to be the company admin of "Acme" but the company doesn't exist
    ...
    Scenario: Associate a worker to a provided company
        When The company  admin sends a request passing companyId "acme123" and userId "user123" to associate the user from the company
    ...
    Scenario: Associate a worker to a provied company  without specifing the company 
        When The company  admin sends a request without passing "companyId" to associate the user to the company
    ...
    Scenario: Associate a worker to a provided company  without specifing the userId
        When The company  admin sends a request without passing "userId" to associate the user to the company
    ...
    Scenario: Dissociate a worker from a provided company 
        When The company  admin sends a request passing "companyId" and "userId" to dissociate the user from the company
    ...
    Scenario: Try to dissociate a worker without passing userId
        When The company  admin sends a request passing "companyId" but not "userId" to dissociate the user from the company
        Then The system return an error message telling that "userId" is mandatory
    
    Scenario: Try to dissociate a worker without passing companyId
        When The company  admin sends a request passing "userId" but not "companyId" to dissociate the user from the company
        Then The system return an error message telling that "companyId" is mandatory
