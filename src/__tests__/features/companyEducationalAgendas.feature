Feature: CompanyEducationalAgendas
  ...
  Scenario: Create new company educational agenda
    When The MetApprendo admin sends a request to create a company educational agenda providing all mandatory data
    Then The system send a successful confirmation

  Scenario: Try to create new company educational agenda without a body
    When The MetApprendo admin sends a request to create a company educational agenda without a body
  ...
  Scenario: Try to create new company educational agenda with missing value idTask
    When The MetApprendo admin sends a request to create a company educational agenda without 'idTask'
  ...
  Scenario: Try to create new company educational agenda with missing value idWorker
    When The MetApprendo admin sends a request to create a company educational agenda without 'idWorker'
  ...
  Scenario: Try to create new company educational agenda with missing value idPill
    When The MetApprendo admin sends a request to create a company educational agenda without 'idPill'
