Feature: CompanyEducationalPaths
  ...
  Scenario: Create new company educational path
    When The MetApprendo admin send a request to create a company educational path
    Then The system send a successful confirmation

 Scenario: Try to create new company educational path without a body
    When The MetApprendo admin send a request to create a company educational path without a body
  ...
  Scenario: Try to create new company educational path with missing value idPath
    When The MetApprendo admin send a request to create a company educational path without 'idPath'
  ...
  Scenario: Try to create new company educational path with missing value titolo
    When The MetApprendo admin send a request to create a company educational path without 'titolo'
  ...
  Scenario: Try to create new company educational path with missing value descrizione
    When The MetApprendo admin send a request to create a company educational path without 'descrizione'
  ...
  Scenario: Try to create new company educational path with missing value idCompany
    When The MetApprendo admin send a request to create a company educational path without 'idCompany'
  ...
  Scenario: Try to create new company educational path with missing value data
    When The MetApprendo admin send a request to create a company educational path without 'data'
