Feature: Educational Pills
    ...
    Scenario: Create new Educational Pills
        When The MetApprendo admin sends a request with all necessary informations to create an Educational Pills
    ...
    Scenario: Try to create a Educational Pills without titolo
        When The MetApprendo admin sends a request without titolo property into the body
